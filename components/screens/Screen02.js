      ...
      <View style={styles.container}>
        ...
        <View style={styles.filterContainer}>
          ...
          <TouchableOpacity
            style={[
              styles.filterButton,
              filter === "Roadbike" && styles.activeFilterButton,
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.filterButton,
              filter === "Mountain" && styles.activeFilterButton,
            ]}
        ...
        <TouchableOpacity style={styles.button} onPress={()=>navigation.navigate("Screen03")}>
